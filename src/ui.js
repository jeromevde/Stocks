...
function renderRow(tbody, stock) {
    ...
    tr.innerHTML = `
        ...
        <td class="price-cell" style="text-align:right">${priceDisplay}</td>
        <td class="return3m-cell" style="text-align:right">${colorReturn(stock.return3m)}</td>
        <td class="cumret-cell" style="text-align:right">${colorReturn(stock.cumulativeReturn)}</td>
