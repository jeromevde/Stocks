...
async function savePortfolioToMarkdown() {
    ...
    try {
        ...
        showStatus(`✅ Portfolio saved to GitHub (${stockCount} stocks)`, 'success');
...
async function loadPortfolioFromGitHub() {
    try {
        ...
        portfolio.push(...portfolioData.map(stock => ({
            ...stock,
...
async function updateAllStockDataAsync(stocks) {
    ...
    showStatus(`All ${total} stocks downloaded successfully!`, 'success');
}
